...
dependencies {
    ...
    implementation("com.google.maps.android:maps-compose:6.6.0") // Or the latest version
    // Optional dependencies:
    implementation("com.google.maps.android:maps-compose-utils:6.6.0") // For Clustering, Street View
}